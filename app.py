...
def create_show():
    try:
        ...
        with connection.cursor() as cur:
            cur.execute("INSERT INTO `Shows` (movie_id, start_time, end_time, category, theater_id, capacity, price) VALUES (%s, %s, %s, %s, %s, %s, %s)", (movie_id, start_time, end_time, category, theater_id, capacity, price))
...
def update_show(show_id):
    try:
        ...
        with connection.cursor() as cur:
            cur.execute("UPDATE `Shows` SET start_time = %s, end_time = %s, category = %s, capacity = %s, price = %s WHERE id = %s", (start_time, end_time, category, capacity, price, show_id))
